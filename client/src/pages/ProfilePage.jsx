...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-xl bg-[#3d3d3d70] text-gray-200 border-2 border-gray-600 flex items-center justify-between max-between max-sm:flex-col-reverse rounded-lg'>
      ...
      <img className={`max-w-40 aspect-square rounded-md mx-10 max-sm:mt-10 ${selectedImg && 'rounded-full'}`} src={authUser?.profilePic || assets.logo_icon} alt="" />
      </div>
